...
HD_PWD='/home/mdl/izo5011/SOC_IT/brute_force_matcher/hardware/ip/xcku115/managed_ip_project/managed_ip_project.runs/ila_300_4096_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ila_300_4096.vds -m64 -mode batch -messageDb vivado.pb -notrace -source ila_300_4096.tcl
